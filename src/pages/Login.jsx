...
const Login = () => {
	...
	return (
		<div className="flex flex-col lg:flex-row lg:h-screen">
			...
			<div className="lg:flex-1 bg-black text-white p-12 flex items-center justify-center">
				<div>
					<h2 className="text-4xl font-bold mb-4 text-center lg:text-left">CourtBooking.com</h2>
